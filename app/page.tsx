...
const whatsappNumber = '51944436004'
...
export default function Page() {
  ...
  return (
    <main>
      <div className="topline"><span>Soluciones de movilidad para vivir tu hogar con más libertad</span><a href="tel:+51944436004">944 436 004</a></div>
      ...
      <footer><div className="footer-main section-shell"><a className="brand footer-brand" href="#inicio"><span className="brand-mark">A</span><span>altura<span className="brand-dot">.</span></span></a><p>Soluciones para vivir<br />tu hogar con libertad.</p><div className="footer-links"><a href="#soluciones">Soluciones</a><a href="#proceso">Cómo funciona</a><a href="#contacto">Contacto</a></div><div className="footer-contact"><a href="mailto:hola@altura.com.ar">hola@altura.com.ar</a><a href="tel:+51944436004">944 436 004</a></div></div><div className="footer-bottom section-shell"><span>© 2024 Altura. Todos los derechos reservados.</span><a id="privacidad" href="#privacidad">Aviso de privacidad</a><span>Buenos Aires · Montevideo</span></div></footer>
