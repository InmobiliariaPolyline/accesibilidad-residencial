...
const whatsappNumber = '+51 944436004'
...
export default function Page() {
  ...
  return (
    <main>
      ...
      <section id="contacto" className="contact-section section-shell"><div className="contact-intro"><p className="kicker">HABLEMOS</p><h2>Da el primer paso<br /><em>hacia más libertad.</em></h2><p>Cuéntanos qué necesitas. Un asesor se pondrá en contacto contigo para orientarte sin compromiso.</p><div className="contact-details"><a href="tel:+51 944436004"><span>Teléfono</span>+51 944436004</a><a href="mailto:hola@altura.com.ar"><span>Email</span>hola@altura.com.ar</a></div></div><div className="form-wrap">{submitted ? <div className="success-message"><div className="success-icon">✓</div><h3>Gracias por escribirnos</h3><p>Recibimos tu solicitud. Un asesor de Altura se pondrá en contacto contigo muy pronto.</p><button className="button button-secondary" onClick={() => setSubmitted(false)}>Enviar otra consulta</button></div> : <form onSubmit={submit}><div className="form-row"><label>Nombre completo<input required name="name" placeholder="Tu nombre" /></label><label>Teléfono<input required name="phone" type="tel" placeholder="+54 11 ..." /></label></div><div className="form-row"><label>Correo electrónico<input required name="email" type="email" placeholder="tu@email.com" /></label><label>Solución de interés<select name="solution" defaultValue=""><option value="" disabled>Selecciona una opción</option><option>Salvaescaleras</option><option>Elevador para movilidad reducida</option><option>Ascensor domiciliario</option></select></label></div><label>¿Cuándo prefieres que te contactemos?<input name="time" placeholder="Ej. Por la mañana, de lunes a viernes" /></label><label>Cuéntanos un poco más<textarea name="comments" rows={3} placeholder="¿Qué necesitas resolver en tu hogar?"></textarea></label><label className="consent"><input required type="checkbox" />Acepto el <a href="#privacidad">aviso de privacidad</a>.</label><button className="button button-primary form-button" type="submit">Solicitar mi cita <Arrow /></button></form>}</div></section>
      ...
      <footer><div className="footer-main section-shell"><a className="brand footer-brand" href="#inicio"><span className="brand-mark">A</span><span>altura<span className="brand-dot">.</span></span></a><p>Soluciones para vivir<br />tu hogar con libertad.</p><div className="footer-links"><a href="#soluciones">Soluciones</a><a href="#proceso">Cómo funciona</a><a href="#contacto">Contacto</a></div><div className="footer-contact"><a href="mailto:hola@altura.com.ar">hola@altura.com.ar</a><a href="tel:+51 944436004">+51 944436004</a></div></div><div className="footer-bottom section-shell"><span>© 2024 Altura. Todos los derechos reservados.</span><a id="privacidad" href="#privacidad">Aviso de privacidad</a><span>Buenos Aires · Montevideo</span></div></footer>
